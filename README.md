[![Build Status 1.16](https://github.com/lwindolf/liferea/actions/workflows/cb.yml/badge.svg?branch=liferea-1_16)](https://github.com/lwindolf/liferea/actions/workflows/cb.yml)
...
###### _Mandatory Dependencies_
   ...
   libxml2-dev libxslt1-dev libsqlite3-dev libwebkit2gtk-4.1-dev libjson-glib-dev libgirepository-2.0-dev
   libpeas-2-dev libfribidi-dev gsettings-desktop-schemas-dev python3 python-gi-dev libtool intltool
...
and extract and compile with
    ...
    tar jxvf liferea-1.16.12.tar.bz2 
    ./configure
    make
    sudo make install
