 ...
 */ 
#define GOOGLE_READER_LOGIN_URL "https://www.reedah.com/accounts/ClientLogin" 
#define GOOGLE_READER_LOGIN_POST "service=reader&Email=%s&Passwd=%s&source=liferea&continue=http://www.reedah.com"
 ...
 */
#define GOOGLE_READER_BROADCAST_FRIENDS_URL "http://www.reedah.com/reader/atom/user/-/state/com.google/broadcast-friends" 

/**
 * Get a list of subscriptions.
 */
#define GOOGLE_READER_SUBSCRIPTION_LIST_URL "http://www.reedah.com/reader/api/0/subscription/list"

/**
 * Get a token for an edit operation. (@todo A token can actually be used
 * for multiple transactions.)
 */
#define GOOGLE_READER_TOKEN_URL "http://www.reedah.com/reader/api/0/token"
 ...
 */
#define GOOGLE_READER_ADD_SUBSCRIPTION_URL "http://www.reedah.com/reader/api/0/subscription/edit?client=liferea"
 ...
 * @param T   a token obtained using GOOGLE_READER_TOKEN_URL
 */
#define GOOGLE_READER_REMOVE_SUBSCRIPTION_URL "http://www.reedah.com/reader/api/0/subscription/edit?client=liferea"
 ...
 * timestamps.
 */
#define GOOGLE_READER_UNREAD_COUNTS_URL "http://www.reedah.com/reader/api/0/unread-count?all=true&client=liferea"

/**
 * Edit the tags associated with an item. The parameters to this _have_ to be
 * sent as post data. 
 */
#define GOOGLE_READER_EDIT_TAG_URL "http://www.reedah.com/reader/api/0/edit-tag?client=liferea"
 ...
 */
nodePtr reedah_source_get_node_from_source (GoogleSourcePtr gsource, const gchar* source);
 ...
 */
void reedah_source_login (GoogleSourcePtr gsource, guint32 flags);
