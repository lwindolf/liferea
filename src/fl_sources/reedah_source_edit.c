...
static void reedah_source_edit_push (GoogleSourcePtr gsource, GoogleSourceActionPtr action, gboolean head);
...
static void 
reedah_source_action_free (GoogleSourceActionPtr action)
{ 
	g_free (action->guid);
...
reedah_source_action_context_new(GoogleSourcePtr gsource, GoogleSourceActionPtr action)
{
...
static void
reedah_source_action_context_free(GoogleSourceActionCtxtPtr ctxt)
{
	g_free(ctxt->nodeId);
...
static void
reedah_source_api_add_subscription (GoogleSourceActionPtr action, updateRequestPtr request, const gchar* token) 
{
...
static void
reedah_source_api_remove_subscription (GoogleSourceActionPtr action, updateRequestPtr request, const gchar* token) 
{
...
static void 
reedah_source_api_edit_tag (GoogleSourceActionPtr action, updateRequestPtr request, const gchar*token) 
{
...
void
reedah_source_edit_process (GoogleSourcePtr gsource)
{ 
	updateRequestPtr request; 
...
static void
reedah_source_edit_push_ (GoogleSourcePtr gsource, GoogleSourceActionPtr action, gboolean head)
{ 
...
static void 
reedah_source_edit_push (GoogleSourcePtr gsource, GoogleSourceActionPtr action, gboolean head)
{
	g_assert (gsource);
...
void
reedah_source_edit_mark_read (GoogleSourcePtr gsource, const gchar *guid, const gchar *feedUrl,	gboolean newStatus)
{
	GoogleSourceActionPtr action = reedah_source_action_new ();
...
void
reedah_source_edit_mark_starred (GoogleSourcePtr gsource, const gchar *guid, const gchar *feedUrl, gboolean newStatus)
{
	GoogleSourceActionPtr action = reedah_source_action_new ();
...
void 
reedah_source_edit_add_subscription (GoogleSourcePtr gsource, const gchar* feedUrl)
{
	GoogleSourceActionPtr action = reedah_source_action_new () ;
...
static void
reedah_source_edit_remove_callback (GoogleSourcePtr gsource, GoogleSourceActionPtr action, gboolean success)
{
	if (success) {	
		/* 
...
void reedah_source_edit_remove_subscription (GoogleSourcePtr gsource, const gchar* feedUrl) 
{
	GoogleSourceActionPtr action = reedah_source_action_new (); 
...
gboolean reedah_source_edit_is_in_queue (GoogleSourcePtr gsource, const gchar* guid) 
{
