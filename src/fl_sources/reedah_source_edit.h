 ...
 */
void reedah_source_edit_process (GoogleSourcePtr gsource);
 ...
 */
void reedah_source_edit_mark_read (GoogleSourcePtr gsource, const gchar* guid, const gchar* feedUrl, gboolean newStatus);
 ...
 * @param newStatus The new read status of the item (TRUE for read)
 */
void reedah_source_edit_mark_starred (GoogleSourcePtr gsource, const gchar *guid, const gchar *feedUrl, gboolean newStatus);
 ...
 */
void reedah_source_edit_add_subscription (GoogleSourcePtr gsource, const gchar* feedUrl);
