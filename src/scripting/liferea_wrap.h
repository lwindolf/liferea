...
static int _wrap_delete_socialSite(lua_State* L) {
  int SWIG_arg = -1;
  struct socialSite *arg1 = (struct socialSite *) 0 ;
  
  SWIG_check_num_args("socialSite::~socialSite",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("socialSite::~socialSite",1,"struct socialSite *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_socialSite,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("delete_socialSite",1,SWIGTYPE_p_socialSite);
  }
