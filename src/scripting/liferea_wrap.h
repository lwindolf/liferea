...
static int _wrap_delete_node(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_node,SWIG_POINTER_DISOWN))){
...
static int _wrap_delete_item(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_item,SWIG_POINTER_DISOWN))){
...
static int _wrap_new_socialBookmarkSite(lua_State* L) {
  ...
  result = (struct socialBookmarkSite *)calloc(1, sizeof(struct socialBookmarkSite));
  SWIG_arg=0;
...
static int _wrap_delete_socialBookmarkSite(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_socialBookmarkSite,SWIG_POINTER_DISOWN))){
...
static const char *swig_socialBookmarkSite_base_names[] = {0};
...
static int _wrap_delete_subscription(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_subscription,SWIG_POINTER_DISOWN))){
