...
typedef struct nodeSourceType {
	 ...
	 */
	Node *		(*add_subscription) (Node *node, struct subscription *subscription);
 ...
 */
Node *node_source_add_subscription (Node *node, struct subscription *subscription);
 ...
 */
nodeProviderPtr node_source_get_provider (void);
