...
typedef struct vfolder {
	Node		*node;		/**< the feed list node of this search folder */
 ...
 */
vfolderPtr vfolder_new (Node *node);
 ...
 */
void vfolder_rebuild (Node *node);

/* implementation of the node type interface */
nodeProviderPtr vfolder_get_provider (void);
