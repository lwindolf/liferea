...
social_init (void)
{
	...
	social_register_bookmark_site ("BlinkBits",	"http://blinkbits.com/bookmarklets/save.php?v=1&source_url=%s&title=%s", TRUE, FALSE);
	...
	social_register_bookmark_site ("de.lirio.us",	"http://de.lirio.us/rubric/post?uri=%s&title=%s", TRUE, FALSE);
	...
	social_register_bookmark_site ("Furl",		"http://www.furl.net/storeIt.jsp?t=%s&u=%s", TRUE, TRUE);
	...
	social_register_bookmark_site ("kinja",		"http://kinja.com/id.knj?url=%s", FALSE, FALSE);
	...
	social_register_bookmark_site ("looklater",	"http://api.looklater.com/bookmarks/save?url=%s&title=%s", TRUE, FALSE);
	social_register_bookmark_site ("Magnolia",	"http://ma.gnolia.com/bookmarklet/add?url=%s&title=%s", TRUE, FALSE);
	social_register_bookmark_site ("maple",		"http://www.maple.nu/bookmarks/bookmarklet?bookmark[url]=%s&bookmark[name]=%s", TRUE, FALSE);
	social_register_bookmark_site ("MesFavs",	"http://mesfavs.com/bookmarks.php/?action=add&address=%s&title=%s", TRUE, FALSE);
	...
	social_register_bookmark_site ("Raw Sugar", 	"http://www.rawsugar.com/tagger/?turl=%s&tttl=%s&editorInitialized=1", TRUE, FALSE);
	social_register_bookmark_site ("reddit",	"http://reddit.com/submit?url=%s&title=%s", TRUE, FALSE);
	social_register_bookmark_site ("Rojo",		"http://www.rojo.com/add-subscription/?resource=%s", FALSE, FALSE);
	social_register_bookmark_site ("Scuttle",	"http://scuttle.org/bookmarks.php/?action=add&address=%s&title=%s", TRUE, FALSE);
	social_register_bookmark_site ("Segnalo",	"http://segnalo.com/post.html.php?url=%s&title=%s", TRUE, FALSE);
	social_register_bookmark_site ("Shadows",	"http://www.shadows.com/shadows.aspx?url=%s", FALSE, FALSE);
	...
	social_register_bookmark_site ("Tailrank",	"http://tailrank.com/share/?title=%s&link_href=%s", TRUE, TRUE);
	social_register_bookmark_site ("Technorati",	"http://technorati.com/faves/?add=%s", FALSE, FALSE);
	social_register_bookmark_site ("unalog",	"http://unalog.com/my/stack/link?url=%s&title=%s", TRUE, FALSE);
	social_register_bookmark_site ("Wink",		"http://www.wink.com/_/tag?url=%s&doctitle=%s", TRUE, FALSE);
