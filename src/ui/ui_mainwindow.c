...
void ui_mainwindow_init(int mainwindowState) {
	...
	g_string_append(buffer,    "<p><b>Important:</b> This is an <b>UNSTABLE</b> test release. Use it only "
				   ...
				   "   <li>searching (untested)</li>"
				   "   <li>tray icon state handling (untested)</li>"
				   "   <li>enclosure auto-download</li>"
				   "   <li>notifications</li>"
				   "   <li>the cache limiting has no effect</li>"
				   "   <li>feed metadata saving/rendering</li>"
				   "</ul>"
				   "</p>"
				   "<p>What works since this release:"
				   "<ul>"
				   "   <li>search folder unread/item count</li>"
				   "   <li>corrected search folder rule mismatches</li>"
				   "   <li>creating new search folders</li>"
				   "   <li>feed update state saving in DB</li>"
				   "</ul>"
				   "</p>");
	g_string_append(buffer,    "</div>");
