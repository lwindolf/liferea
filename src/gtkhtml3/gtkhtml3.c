...
void launch_url(const gchar *url) { g_warning("should not be called!"); on_link_clicked(NULL, url, NULL); }
...
gchar * get_module_name(void) { return g_strdup(_("GtkHTML3 (experimental)")); }
