...
typedef struct GoogleReaderAction {
	 ...
	 */
	gchar* (*get_stream_id_for_node) (Node *node);
...
void
google_reader_api_edit_remove_subscription (nodeSourcePtr source, const gchar* feedUrl, gchar* (*get_stream_id_for_node) (Node *node))
{
